...
<div on:click={closePopup} class="fixed inset-0 z-50 flex items-end bg-popap">
	<div class="relative flex w-full flex-col items-center gap-8 bg-white p-8 pb-32 pt-16">
				...
				>
					...
					<defs>
						<clipPath id="clip0_126_1072">
							<rect width="105.015" height="105.015" fill="white" transform="translate(0.595703)" />
						</clipPath>
					</defs>
				</svg>
			</a>
			<button type="button" class=" absolute right-8 top-5" on:click={closePopup}>
				<svg
					width="25"
					height="25"
					viewBox="0 0 25 25"
