<script lang="ts">
	...
	const handleResize = () => {
		// window.innerWidth === 1440 ? (showAll = true) : (showAll = false);
	...
	// Слухач подій для зміни розміру вікна
	window.addEventListener('resize', handleResize);

	// Перевірка розміру вікна при завантаженні сторінки
	onMount(() => {
		handleResize();
	});
</script>
	...
	<Container classes="2xl:px-16">
		<div class="pb-10 pt-20 text-black">
			...
			<Fade_In_Out duration={1000} threshold={0.2}>
				<div class="2xl:mb-10 2xl:flex 2xl:gap-40">
					<div class="lg:flex lg:justify-center 2xl:ml-2.5">
						<Image
							classes="px-10 2xl:px-2.5 2xl:max-w-[510px] 2xl:max-h-[600px]"
					...
					<div class="2xl:mb-10 2xl:flex 2xl:flex-row-reverse 2xl:gap-40">
						...
						<div class="flex flex-col gap-8">
							...
							<Paragraph>
								...
								в органах карного розшуку в складі Міністерства внутрішніх справ України, старшого слідчого
							...
							{/if}
							<Button
								classes="text-pepel ml-auto mb-10 text-sm 2xl:hidden"
						...
						<div class="flex flex-col gap-8">
							...
							{#if showAll}
								...
								<Paragraph>
									...
									її важливим ресурсом для будь-якої юридичної фірми. Олена Васильєва - це гарантія якісної
						...
						<div class="flex flex-col gap-8">
							...
							{#if showAll}
								...
								<Paragraph>
									...
									глибокі знання та практичний досвід у Європейському Союзі, країнах Кавказу та Азії,
									зокрема у бізнесі та електронній комерції. Її робота в Грузії, Туреччині, Китаї та
								...
								<Paragraph>
									...
									та легально працювати в різних країнах світу. Лілія - експерт, який не тільки
									виведе вас зі складних юридичних лабіринтів, але й допоможе будувати міцний
									фундамент для вашого майбутнього успіху у бізнесі та інвестиціях.
								</Paragraph>
							{/if}
							<Button
								classes="text-pepel ml-auto mb-10 text-sm 2xl:hidden"
						...
						<div class="flex flex-col gap-8">
							...
							{#if showAll}
								...
								<Paragraph>
									...
									сфері гарантують, що клієнти отримують найкращу правову допомогу. З таким адвокатом
									ви можете бути впевнені в успішному вирішенні ваших правових питань.
								</Paragraph>
							{/if}
							<Button
								classes="text-pepel ml-auto mb-10 text-sm 2xl:hidden"
