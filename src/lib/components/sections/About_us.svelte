				...
				<div class="flex flex-col gap-5 text-lg">
					...
					<Fade_In_Out duration={1000} threshold={0.2}>
						<Paragraph>
							...
							юридичних питань різної складності. Наші адвокати мають багатий досвід у кримінальному,
							господарському, цивільному, корпоративному та адміністративному праві. Останнім часом наша
							команда активно спеціалізується на військовому праві, що дозволяє нам ефективно вирішувати
							правові питання, пов'язані з військовою сферою. Кожна справа, яку ми ведемо, отримує належну
							увагу та професійний підхід.
						</Paragraph>
					</Fade_In_Out>
					<Fade_In_Out duration={1000} threshold={0.2}>
						<Paragraph>
							...
							Ми домоглися значної кількості виправдовувальних вироків та виграшів у складних судових
