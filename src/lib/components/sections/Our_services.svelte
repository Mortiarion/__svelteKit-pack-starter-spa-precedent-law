<script lang="ts">
	...
	let activeCategory: string = categories[0]; // Активна категорія за замовчуванням
	let subCategory: string = ''; // Підкатегорія за замовчуванням
...
<style lang="postcss">
	...
	.filter-button {
		...
		/* filter: drop-shadow(28px 15px 13px rgba(138, 133, 133, 0.01)) drop-shadow(16px 8px 11px rgba(138, 133, 133, 0.05)) drop-shadow(7px 4px 8px rgba(138, 133, 133, 0.09)) drop-shadow(2px 1px 4px rgba(138, 133, 133, 0.1)); */
	}
	.filter-button:hover {
